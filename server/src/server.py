...
async def create_item(list_id:str,new_item:NewItem)-> ToDoList:
    return app.todo_dal.create_item(list_id,new_item.label)

@app.delete("/api/lists/{list_id}/items/{item_id}")
async def delete_item(list_id:str,item_id:str)->ToDoList:
    return await app.todo_dal.delet_item(list_id,item_id)
...
async def set_checked_state(list_id:str,update:ToDoUpdate)->ToDoList:
